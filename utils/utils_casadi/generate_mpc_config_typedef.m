function generate_mpc_config_typedef(filepath, unique_f_opt_input_map, unique_f_opt_output_map, param_casadi_fun_name)

    structName = 'mpc_config';
    filename=[filepath, structName, '_types.h'];
    ...
    fprintf(fid, '#include "mpc_config_typedefs.h"\n\n');
