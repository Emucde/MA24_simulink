function [arg_addr, res_addr, w_end_address] = calc_udp_cfun_addresses(casadi_fun, casadi_fun_input_cell, casadi_fun_output_cell, output_dir)
...
% hidden in the casadi function ...)
    ...
    adressdef_header_name = [casadi_fun_name, '_addressdef.h'];
