% % MPC v11: Optimization problem - Parametric Dynamic Integrator MPC
...
% The difference to v10 is that it uses a polynomial parameterization for the control inputs.
