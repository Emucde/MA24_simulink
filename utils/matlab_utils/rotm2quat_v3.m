function q = rotm2quat_v3(R)
    ...
    q1 = my_sign(r32 - r23) * sqrt(abs(r11 - r22 - r33 + 1)) / 2;
    q2 = my_sign(r13 - r31) * sqrt(abs(r22 - r33 - r11 + 1)) / 2;
    q3 = my_sign(r21 - r12) * sqrt(abs(r33 - r11 - r22 + 1)) / 2;
    
    % Assemble the quaternion
    q = [q0; q1; q2; q3];
    warning('rotm2quat_v3 is not robust to numerical errors for numbers < 2.2204e-16 = eps. Use rotm2quat_v4 instead.');
