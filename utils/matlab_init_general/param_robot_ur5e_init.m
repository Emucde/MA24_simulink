...
% Lenght of limbs
ur5e.param.l1 = 0.130; % m
ur5e.param.l2 = 0.540; % m
ur5e.param.l3 = 0.490; % m
ur5e.param.l4 = 0.110; % m
ur5e.param.l5 = 0.110; % m
