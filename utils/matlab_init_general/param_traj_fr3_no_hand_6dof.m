...
Q_pos = 1e-10*diag([1e3,1e3,1e3,1e5,1e5,1e5,1e5]);  % Weight for the position error in the cost function.
Q_m = 1e-10;             % Weight for the manipulability error in the cost function.
