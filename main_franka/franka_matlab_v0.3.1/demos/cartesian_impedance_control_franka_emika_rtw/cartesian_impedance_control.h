...
struct B_cartesian_impedance_control_T {
  ...
  real_T Subtract1[7];                 /* '<S1>/Subtract1' */
  real_T GetRobotState2_o1[6];         /* '<Root>/Get Robot State2' */
  real_T GetRobotState2_o2[16];        /* '<Root>/Get Robot State2' */
};
 ...
 * '<S2>'   : 'cartesian_impedance_control/Cartesian Impedance Controller/MATLAB Function'
 */
