...
## Generated on : Fri Oct 18 16:05:17 2024
...
PRODUCT_NAME              = cartesian_impedance_control
MAKEFILE                  = cartesian_impedance_control.mk
MATLAB_ROOT               = /usr/local/MATLAB/R2022b
MATLAB_BIN                = /usr/local/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/glnxa64
START_DIR                 = /home/rslstudent/Students/Emanuel/MA24_simulink/main_franka/Controller/s_functions
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/cartesian_impedance_control
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/cartesian_impedance_control_franka_emika_rtw -I/home/rslstudent/Students/Emanuel/MA24_simulink/main_franka/Controller -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
...
OBJS = xcp_ext_work.o rt_matrx.o rt_printf.o rt_logging.o cartesian_impedance_control.o cartesian_impedance_control_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_tcp.o xcp_ext_param_default_tcp.o xcp_platform_default.o rtiostream_tcpip.o s_function_opti_robot_model_bus_fun.o s_function_opti_sys_fun_qpp_aba.o shm_reader_sfun.o shm_writer_sfun.o sizes_codegen.o gripper_api.o robot_api.o control_modes.o robot_model_bus_fun.o sys_fun_qpp_aba.o
...
%.o : /home/rslstudent/Students/Emanuel/MA24_simulink/main_franka/franka_matlab_v0.3.1/franka_simulink_library/blocks/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : /home/rslstudent/Students/Emanuel/MA24_simulink/main_franka/franka_matlab_v0.3.1/franka_simulink_library/blocks/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/cartesian_impedance_control_franka_emika_rtw/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/cartesian_impedance_control_franka_emika_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
cartesian_impedance_control.o : $(START_DIR)/cartesian_impedance_control_franka_emika_rtw/cartesian_impedance_control.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


cartesian_impedance_control_data.o : $(START_DIR)/cartesian_impedance_control_franka_emika_rtw/cartesian_impedance_control_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/cartesian_impedance_control_franka_emika_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/cartesian_impedance_control_franka_emika_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_main.o : $(START_DIR)/cartesian_impedance_control_franka_emika_rtw/rt_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/cartesian_impedance_control_franka_emika_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
s_function_opti_robot_model_bus_fun.o : $(START_DIR)/s_function_opti_robot_model_bus_fun.c
	$(CC) $(CFLAGS) -o"$@" "$<"


s_function_opti_sys_fun_qpp_aba.o : $(START_DIR)/s_function_opti_sys_fun_qpp_aba.c
	$(CC) $(CFLAGS) -o"$@" "$<"


shm_reader_sfun.o : $(START_DIR)/shm_reader_sfun.c
	$(CC) $(CFLAGS) -o"$@" "$<"


shm_writer_sfun.o : $(START_DIR)/shm_writer_sfun.c
	$(CC) $(CFLAGS) -o"$@" "$<"
...
gripper_api.o : /home/rslstudent/Students/Emanuel/MA24_simulink/main_franka/franka_matlab_v0.3.1/franka_simulink_library/src/gripper_api.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


robot_api.o : /home/rslstudent/Students/Emanuel/MA24_simulink/main_franka/franka_matlab_v0.3.1/franka_simulink_library/src/robot_api.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
robot_model_bus_fun.o : $(START_DIR)/robot_model_bus_fun.c
	$(CC) $(CFLAGS) -o"$@" "$<"


sys_fun_qpp_aba.o : $(START_DIR)/sys_fun_qpp_aba.c
	$(CC) $(CFLAGS) -o"$@" "$<"
