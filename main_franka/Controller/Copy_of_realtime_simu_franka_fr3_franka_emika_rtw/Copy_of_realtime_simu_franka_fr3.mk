###########################################################################
## Makefile generated for component 'Copy_of_realtime_simu_franka_fr3'. 
## 
## Makefile     : Copy_of_realtime_simu_franka_fr3.mk
## Generated on : Fri Nov 22 16:42:33 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Copy_of_realtime_simu_franka_fr3
...
PRODUCT_NAME              = Copy_of_realtime_simu_franka_fr3
MAKEFILE                  = Copy_of_realtime_simu_franka_fr3.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Copy_of_realtime_simu_franka_fr3
...
DEFINES_STANDARD = -DMODEL=Copy_of_realtime_simu_franka_fr3 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
OBJS = xcp_ext_work.o rt_logging.o Copy_of_realtime_simu_franka_fr3.o Copy_of_realtime_simu_franka_fr3_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_tcp.o xcp_ext_param_default_tcp.o xcp_platform_default.o rtiostream_tcpip.o sizes_codegen.o gripper_api.o robot_api.o control_modes.o
...
%.o : $(START_DIR)/Copy_of_realtime_simu_franka_fr3_franka_emika_rtw/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/Copy_of_realtime_simu_franka_fr3_franka_emika_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Copy_of_realtime_simu_franka_fr3.o : $(START_DIR)/Copy_of_realtime_simu_franka_fr3_franka_emika_rtw/Copy_of_realtime_simu_franka_fr3.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Copy_of_realtime_simu_franka_fr3_data.o : $(START_DIR)/Copy_of_realtime_simu_franka_fr3_franka_emika_rtw/Copy_of_realtime_simu_franka_fr3_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Copy_of_realtime_simu_franka_fr3_franka_emika_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Copy_of_realtime_simu_franka_fr3_franka_emika_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_main.o : $(START_DIR)/Copy_of_realtime_simu_franka_fr3_franka_emika_rtw/rt_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Copy_of_realtime_simu_franka_fr3_franka_emika_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
