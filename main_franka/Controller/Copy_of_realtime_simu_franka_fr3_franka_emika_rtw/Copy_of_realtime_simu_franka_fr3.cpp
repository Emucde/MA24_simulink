...
void Copy_of_realtime_simu_franka_fr3_initialize(void)
{
  ...
  /* External mode info */
  Copy_of_realtime_simu_franka_M->Sizes.checksums[0] = (1070160195U);
  Copy_of_realtime_simu_franka_M->Sizes.checksums[1] = (983568699U);
  Copy_of_realtime_simu_franka_M->Sizes.checksums[2] = (1036556389U);
  Copy_of_realtime_simu_franka_M->Sizes.checksums[3] = (1989894115U);
