###########################################################################
## Makefile generated for component 'joint_impedance_control'. 
## 
## Makefile     : joint_impedance_control.mk
## Generated on : Fri Nov 22 16:36:33 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/joint_impedance_control
...
PRODUCT_NAME              = joint_impedance_control
MAKEFILE                  = joint_impedance_control.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/joint_impedance_control
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/joint_impedance_control_franka_emika_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
...
OBJS = xcp_ext_work.o rt_logging.o joint_impedance_control.o joint_impedance_control_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_tcp.o xcp_ext_param_default_tcp.o xcp_platform_default.o rtiostream_tcpip.o sizes_codegen.o gripper_api.o robot_api.o control_modes.o
...
%.o : $(START_DIR)/joint_impedance_control_franka_emika_rtw/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/joint_impedance_control_franka_emika_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
joint_impedance_control.o : $(START_DIR)/joint_impedance_control_franka_emika_rtw/joint_impedance_control.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


joint_impedance_control_data.o : $(START_DIR)/joint_impedance_control_franka_emika_rtw/joint_impedance_control_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/joint_impedance_control_franka_emika_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/joint_impedance_control_franka_emika_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_main.o : $(START_DIR)/joint_impedance_control_franka_emika_rtw/rt_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/joint_impedance_control_franka_emika_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
