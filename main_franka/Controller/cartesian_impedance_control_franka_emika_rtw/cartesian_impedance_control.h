...
struct B_cartesian_impedance_control_T {
  ...
  real_T SFunction3_o1[250];           /* '<Root>/S-Function3' */
...
struct DW_cartesian_impedance_control_T {
  ...
  real_T e_I[7];                       /* '<Root>/Joinspace controller' */
...
struct P_cartesian_impedance_control_T_ {
  ...
  real_T Constant3_Value[7];           /* Expression: [10 10 10 10 10 10 10]
                                        ...
                                        */
  real_T Constant7_Value[7];           /* Expression: zeros(1,7)
                                        * Referenced by: '<Root>/Constant7'
                                        */
  real_T Constant6_Value[7];           /* Expression: 1e-2*[1 1 1 1 1 1 1]
