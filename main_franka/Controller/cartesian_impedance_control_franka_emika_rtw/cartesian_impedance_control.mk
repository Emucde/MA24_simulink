...
## Generated on : Thu Oct 17 14:03:48 2024
...
shm_reader_sfun.o : $(START_DIR)/s_functions/shm_reader_sfun.c
	$(CC) $(CFLAGS) -o"$@" "$<"


shm_writer_sfun.o : $(START_DIR)/s_functions/shm_writer_sfun.c
	$(CC) $(CFLAGS) -o"$@" "$<"
