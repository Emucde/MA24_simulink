...
param_casadi_fun_name.(MPC).version = 'v1'; % (v1: (J(u,y)) | v3_rpy: ineq | v3_quat | v4_kin_thelen | v4_kin_ref_dev )
...
param_casadi_fun_name.(MPC).variant = 'nlpsol';
param_casadi_fun_name.(MPC).solver  = 'qrqp'; % (qrqp (sqp) | qpoases | ipopt)
param_casadi_fun_name.(MPC).version  = 'v3_quat'; % (v1: (J(u,y)) | v3_rpy: ineq | v3_quat | v4_kin_thelen | v4_kin_ref_dev )
...
param_casadi_fun_name.(MPC).variant = 'nlpsol';
param_casadi_fun_name.(MPC).solver  = 'qrqp'; % (qrqp (sqp) | qpoases | ipopt)
param_casadi_fun_name.(MPC).version  = 'v3_rpy'; % (v1: (J(u,y)) | v3_rpy: ineq | v3_quat | v4_kin_thelen | v4_kin_ref_dev )
param_casadi_fun_name.(MPC).Ts      = 1e-3;
param_casadi_fun_name.(MPC).rk_iter = 1;
param_casadi_fun_name.(MPC).N_MPC   = 10;
param_casadi_fun_name.(MPC).compile_mode = 1; %1: nlpsol-sfun, 2: opti-sfun
...
param_casadi_fun_name.(MPC).variant = 'nlpsol';
param_casadi_fun_name.(MPC).solver  = 'qrqp'; % (qrqp (sqp) | qpoases | ipopt)
param_casadi_fun_name.(MPC).version  = 'v4_kin_thelen'; % (v1: (J(u,y)) | v3_rpy: ineq | v3_quat | v4_kin_thelen | v4_kin_ref_dev )
param_casadi_fun_name.(MPC).Ts      = 1e-3;
param_casadi_fun_name.(MPC).rk_iter = 1;
param_casadi_fun_name.(MPC).N_MPC   = 5;
param_casadi_fun_name.(MPC).compile_mode = 1; %1: nlpsol-sfun, 2: opti-sfun
...
param_casadi_fun_name.(MPC).variant = 'nlpsol';
param_casadi_fun_name.(MPC).solver  = 'qrqp'; % (qrqp (sqp) | qpoases | ipopt)
param_casadi_fun_name.(MPC).version  = 'v4_int_ref_dev'; % (v1: (J(u,y)) | v3_rpy: ineq | v3_quat | v4_kin_thelen | v4_kin_ref_dev )
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
param_casadi_fun_struct = param_casadi_fun_name.MPC9;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
