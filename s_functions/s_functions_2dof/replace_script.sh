...
if [[ $variant == "opti" ]]; then
   input="./s_functions/s_functions_2dof/templates/template_offline_MCP_s_fun_opti_shared_subsystem.slx"
   MPC_string="MPC2"
   solver_string="qrqp"
   idx_val=3
else
   input="./s_functions/s_functions_2dof/templates/template_offline_MCP_s_fun_nlpsol_shared_subsystem.slx"
   MPC_string="MPC1"
   solver_string="ipopt"
   idx_val=2
fi
...
out_dir="./s_functions/s_functions_2dof/MPC_shared_subsystems/"
mv $output $out_dir
