#define S_FUNCTION_NAME  s_function_opti_MPC3
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    int_T n_in  = MPC3_n_in();
    int_T n_out = MPC3_n_out();
    ...
    for (i=0;i<n_in;++i) {
      const int_T* sp = MPC3_sparsity_in(i);
    ...
    for (i=0;i<n_out;++i) {
      const int_T* sp = MPC3_sparsity_out(i);
