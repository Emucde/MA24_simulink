...
static int casadi_f1(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a31=arg[6]? arg[6][1] : 0;
  if (res[3]!=0) res[3][47]=a31;
  if (res[3]!=0) res[3][48]=a22;
  a22=arg[6]? arg[6][3] : 0;
  if (res[3]!=0) res[3][49]=a22;
  a22=arg[6]? arg[6][4] : 0;
  if (res[3]!=0) res[3][50]=a22;
  a22=arg[6]? arg[6][5] : 0;
  if (res[3]!=0) res[3][51]=a22;
  if (res[3]!=0) res[3][52]=a20;
  a20=arg[7]? arg[7][1] : 0;
  if (res[3]!=0) res[3][53]=a20;
  if (res[3]!=0) res[3][54]=a5;
  a5=arg[7]? arg[7][3] : 0;
  if (res[3]!=0) res[3][55]=a5;
  a5=arg[7]? arg[7][4] : 0;
  if (res[3]!=0) res[3][56]=a5;
  a5=arg[7]? arg[7][5] : 0;
  if (res[3]!=0) res[3][57]=a5;
...
static int casadi_f4(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a117=(a117-a114);
  if (res[1]!=0) res[1][18]=a117;
  a117=(a115*a108);
  a95=(a95+a117);
  a117=arg[0]? arg[0][29] : 0;
  a95=(a95-a117);
...
static int casadi_f6(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  if (res[3]!=0) res[3][4]=a94;
  if (res[3]!=0) res[3][5]=a94;
  if (res[3]!=0) res[3][6]=a94;
