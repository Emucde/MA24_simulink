...
/* get_outputs_MX:(i0[4],i1[7x6],i2[2x5],i3[4x6],i4[34],i5[24],i6[6x6,6nz],i7[6x6,6nz],i8[6x6,6nz],i9[7x7,7nz],i10[14],i11[14],i12[7],i13[7])->(o0,o1[34],o2[24],o3[113],o4[34],o5[24]) */
static int casadi_f1(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  if (res[3]!=0) res[3][0]=a52;
  if (res[3]!=0) res[3][1]=a53;
  if (res[3]!=0) res[3][2]=a54;
  if (res[3]!=0) res[3][3]=a55;
  a55=arg[1]? arg[1][0] : 0;
  if (res[3]!=0) res[3][4]=a55;
  a55=arg[1]? arg[1][1] : 0;
  if (res[3]!=0) res[3][5]=a55;
  a55=arg[1]? arg[1][2] : 0;
  if (res[3]!=0) res[3][6]=a55;
  a55=arg[1]? arg[1][3] : 0;
  if (res[3]!=0) res[3][7]=a55;
  a55=arg[1]? arg[1][4] : 0;
  if (res[3]!=0) res[3][8]=a55;
  a55=arg[1]? arg[1][5] : 0;
  ...
  a33=arg[1]? arg[1][8] : 0;
  if (res[3]!=0) res[3][12]=a33;
  if (res[3]!=0) res[3][13]=a40;
  a40=arg[1]? arg[1][10] : 0;
  if (res[3]!=0) res[3][14]=a40;
  a40=arg[1]? arg[1][11] : 0;
  if (res[3]!=0) res[3][15]=a40;
  a40=arg[1]? arg[1][12] : 0;
  if (res[3]!=0) res[3][16]=a40;
  ...
  if (res[3]!=0) res[3][52]=a39;
  a39=arg[7]? arg[7][1] : 0;
  if (res[3]!=0) res[3][53]=a39;
  if (res[3]!=0) res[3][54]=a34;
  a34=arg[7]? arg[7][3] : 0;
  if (res[3]!=0) res[3][55]=a34;
  a34=arg[7]? arg[7][4] : 0;
  if (res[3]!=0) res[3][56]=a34;
  a34=arg[7]? arg[7][5] : 0;
  if (res[3]!=0) res[3][57]=a34;
  if (res[3]!=0) res[3][58]=a45;
  a45=arg[8]? arg[8][1] : 0;
  if (res[3]!=0) res[3][59]=a45;
  ...
  if (res[3]!=0) res[3][65]=a9;
  a9=arg[9]? arg[9][2] : 0;
  if (res[3]!=0) res[3][66]=a9;
...
/* get_limits_MX:(i0[4],i1[7x6],i2[2x5],i3[4x6],i4[34],i5[24],i6[6x6,6nz],i7[6x6,6nz],i8[6x6,6nz],i9[7x7,7nz],i10[14],i11[14],i12[7],i13[7])->(o0[34],o1[34],o2[24x1,0nz],o3[24x1,0nz]) */
...
/* nlp_grad:(x[34],p[113],lam_f,lam_g[24])->(f,g[24],grad_gamma_x[34],grad_gamma_p[113]) */
static int casadi_f4(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  if (res[3]!=0) res[3][2]=a117;
  if (res[3]!=0) res[3][3]=a118;
  a118=0.;
  if (res[3]!=0) res[3][4]=a118;
  if (res[3]!=0) res[3][5]=a118;
  if (res[3]!=0) res[3][6]=a118;
  if (res[3]!=0) res[3][7]=a118;
  if (res[3]!=0) res[3][8]=a118;
  if (res[3]!=0) res[3][9]=a118;
  ...
  if (res[3]!=0) res[3][30]=a118;
  if (res[3]!=0) res[3][31]=a118;
  a52=(a52*a116);
  a43=(a45*a116);
  a22=(a22*a43);
  a52=(a52+a22);
  a52=(-a52);
  if (res[3]!=0) res[3][32]=a52;
  if (res[3]!=0) res[3][33]=a118;
  a58=(a58*a116);
  a52=(a57*a116);
  a28=(a28*a52);
  a58=(a58+a28);
  a58=(-a58);
  if (res[3]!=0) res[3][34]=a58;
  if (res[3]!=0) res[3][35]=a118;
  if (res[3]!=0) res[3][36]=a118;
  if (res[3]!=0) res[3][37]=a118;
  if (res[3]!=0) res[3][38]=a118;
  a89=(a89*a116);
  a58=(a77*a116);
  a84=(a84*a58);
  a89=(a89+a84);
  ...
  if (res[3]!=0) res[3][42]=a118;
  if (res[3]!=0) res[3][43]=a118;
  if (res[3]!=0) res[3][44]=a118;
  ...
  a3=(a3*a78);
  a45=(a45+a3);
  if (res[3]!=0) res[3][46]=a45;
  if (res[3]!=0) res[3][47]=a118;
  a57=(a57*a52);
  a42=(a42*a37);
  a57=(a57+a42);
  a23=(a23*a20);
  a57=(a57+a23);
  if (res[3]!=0) res[3][48]=a57;
  if (res[3]!=0) res[3][49]=a118;
  if (res[3]!=0) res[3][50]=a118;
  if (res[3]!=0) res[3][51]=a118;
  a60=(a60*a117);
  if (res[3]!=0) res[3][52]=a60;
  if (res[3]!=0) res[3][53]=a118;
  a70=(a70*a72);
  if (res[3]!=0) res[3][54]=a70;
  if (res[3]!=0) res[3][55]=a118;
  if (res[3]!=0) res[3][56]=a118;
  if (res[3]!=0) res[3][57]=a118;
  a77=(a77*a58);
  if (res[3]!=0) res[3][58]=a77;
  if (res[3]!=0) res[3][59]=a118;
  a16=(a16*a89);
  if (res[3]!=0) res[3][60]=a16;
  if (res[3]!=0) res[3][61]=a118;
  if (res[3]!=0) res[3][62]=a118;
  if (res[3]!=0) res[3][63]=a118;
  if (res[3]!=0) res[3][64]=a118;
  a16=(a110*a116);
  a110=(a110*a16);
  a16=(a106*a116);
  a106=(a106*a16);
  ...
  a94=(a94*a116);
  a112=(a112+a94);
  if (res[3]!=0) res[3][67]=a112;
  if (res[3]!=0) res[3][68]=a118;
  if (res[3]!=0) res[3][69]=a118;
  if (res[3]!=0) res[3][70]=a118;
  if (res[3]!=0) res[3][71]=a118;
  if (res[3]!=0) res[3][72]=a118;
  if (res[3]!=0) res[3][73]=a118;
  if (res[3]!=0) res[3][74]=a118;
  if (res[3]!=0) res[3][75]=a118;
  if (res[3]!=0) res[3][76]=a118;
  if (res[3]!=0) res[3][77]=a118;
  if (res[3]!=0) res[3][78]=a118;
  if (res[3]!=0) res[3][79]=a118;
  if (res[3]!=0) res[3][80]=a118;
  if (res[3]!=0) res[3][81]=a118;
  if (res[3]!=0) res[3][82]=a118;
  if (res[3]!=0) res[3][83]=a118;
  if (res[3]!=0) res[3][84]=a118;
  if (res[3]!=0) res[3][85]=a118;
  if (res[3]!=0) res[3][86]=a118;
  if (res[3]!=0) res[3][87]=a118;
  if (res[3]!=0) res[3][88]=a118;
  if (res[3]!=0) res[3][89]=a118;
  if (res[3]!=0) res[3][90]=a118;
  if (res[3]!=0) res[3][91]=a118;
  if (res[3]!=0) res[3][92]=a118;
  if (res[3]!=0) res[3][93]=a118;
  if (res[3]!=0) res[3][94]=a118;
  if (res[3]!=0) res[3][95]=a118;
  if (res[3]!=0) res[3][96]=a118;
  if (res[3]!=0) res[3][97]=a118;
  if (res[3]!=0) res[3][98]=a118;
  if (res[3]!=0) res[3][99]=a118;
  if (res[3]!=0) res[3][100]=a118;
  if (res[3]!=0) res[3][101]=a118;
  if (res[3]!=0) res[3][102]=a118;
  if (res[3]!=0) res[3][103]=a118;
  if (res[3]!=0) res[3][104]=a118;
  if (res[3]!=0) res[3][105]=a118;
  if (res[3]!=0) res[3][106]=a118;
  if (res[3]!=0) res[3][107]=a118;
  if (res[3]!=0) res[3][108]=a118;
  if (res[3]!=0) res[3][109]=a118;
  if (res[3]!=0) res[3][110]=a118;
  if (res[3]!=0) res[3][111]=a118;
  if (res[3]!=0) res[3][112]=a118;
  return 0;
}

/* nlp_fg:(x[34],p[113])->(f,g[24]) */
...
/* nlp_jac_fg:(x[34],p[113])->(f,grad_f_x[34],g[24],jac_g_x[24x34,64nz]) */
...
/* nlp_hess_l:(x[34],p[113],lam_f,lam_g[24])->(hess_gamma_x_x[34x34,30nz]) */
...
/* solver:(x0[34],p[113],lbx[34],ubx[34],lbg[24],ubg[24],lam_x0[34],lam_g0[24])->(x[34],f,g[24],lam_x[34],lam_g[24],lam_p[113]) */
static int casadi_f3(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  casadi_scal(113, -1.0, d_nlp.lam_p);
  ...
  if (d_nlp.lam_p) casadi_copy(d_nlp.lam_p, 113, d_nlp.lam_p);
  return 0;
}
...
/* get_costs_MX:(i0[4],i1[7x6],i2[2x5],i3[4x6],i4[34],i5[24],i6[6x6,6nz],i7[6x6,6nz],i8[6x6,6nz],i9[7x7,7nz],i10[14],i11[14],i12[7],i13[7])->(o0,o1,o2,o3,o4) */
...
CASADI_SYMBOL_EXPORT int MPC8_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  ...
  if (sz_w) *sz_w = 2939*sizeof(casadi_real);
  return 0;
}
