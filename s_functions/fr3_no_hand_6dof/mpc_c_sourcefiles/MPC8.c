...
static int casadi_f1(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a15=(a11*a15);
  a3=(a3+a15);
  a15=1.0700000000000000e-01;
  a20=(a16*a13);
  a20=(a20-a17);
  a20=(a16*a20);
  a19=1.3596310734468911e-32;
  a17=(a19*a17);
  a13=(a14*a13);
  a17=(a17+a13);
  a17=(a17-a9);
  ...
  if (res[3]!=0) res[3][6]=a35;
  if (res[3]!=0) res[3][7]=a40;
  if (res[3]!=0) res[3][8]=a20;
  if (res[3]!=0) res[3][9]=a23;
  if (res[3]!=0) res[3][10]=a28;
  if (res[3]!=0) res[3][11]=a26;
  if (res[3]!=0) res[3][12]=a31;
  if (res[3]!=0) res[3][13]=a29;
  if (res[3]!=0) res[3][14]=a42;
  if (res[3]!=0) res[3][15]=a15;
  if (res[3]!=0) res[3][16]=a17;
  if (res[3]!=0) res[3][17]=a10;
  if (res[3]!=0) res[3][18]=a38;
  if (res[3]!=0) res[3][19]=a36;
  if (res[3]!=0) res[3][20]=a44;
  if (res[3]!=0) res[3][21]=a16;
  if (res[3]!=0) res[3][22]=a9;
  if (res[3]!=0) res[3][23]=a14;
  a14=arg[10]? arg[10][0] : 0;
  if (res[3]!=0) res[3][24]=a14;
  a14=arg[10]? arg[10][1] : 0;
  if (res[3]!=0) res[3][25]=a14;
  a14=arg[10]? arg[10][2] : 0;
  if (res[3]!=0) res[3][26]=a14;
  a14=arg[10]? arg[10][3] : 0;
  if (res[3]!=0) res[3][27]=a14;
  a14=arg[11]? arg[11][0] : 0;
  if (res[3]!=0) res[3][28]=a14;
  a14=arg[11]? arg[11][1] : 0;
  if (res[3]!=0) res[3][29]=a14;
  a14=arg[11]? arg[11][2] : 0;
  if (res[3]!=0) res[3][30]=a14;
  a14=arg[11]? arg[11][3] : 0;
  if (res[3]!=0) res[3][31]=a14;
  a14=arg[12]? arg[12][0] : 0;
  if (res[3]!=0) res[3][32]=a14;
  a14=arg[12]? arg[12][1] : 0;
  if (res[3]!=0) res[3][33]=a14;
  a14=arg[13]? arg[13][0] : 0;
  if (res[3]!=0) res[3][34]=a14;
  a14=arg[13]? arg[13][1] : 0;
  if (res[3]!=0) res[3][35]=a14;
  a14=arg[4]? arg[4][0] : 0;
  if (res[4]!=0) res[4][0]=a14;
  a14=arg[4]? arg[4][1] : 0;
  if (res[4]!=0) res[4][1]=a14;
  a14=arg[4]? arg[4][2] : 0;
  if (res[4]!=0) res[4][2]=a14;
  a14=arg[4]? arg[4][3] : 0;
  ...
  if (res[4]!=0) res[4][12]=a14;
  a14=arg[4]? arg[4][13] : 0;
  if (res[4]!=0) res[4][13]=a14;
  a14=arg[4]? arg[4][14] : 0;
  if (res[4]!=0) res[4][14]=a14;
  a14=arg[4]? arg[4][15] : 0;
  if (res[4]!=0) res[4][15]=a14;
  a14=arg[4]? arg[4][16] : 0;
  if (res[4]!=0) res[4][16]=a14;
  a14=arg[4]? arg[4][17] : 0;
  if (res[4]!=0) res[4][17]=a14;
  a14=arg[4]? arg[4][18] : 0;
  if (res[4]!=0) res[4][18]=a14;
  a14=arg[4]? arg[4][19] : 0;
  if (res[4]!=0) res[4][19]=a14;
  a14=arg[4]? arg[4][20] : 0;
  if (res[4]!=0) res[4][20]=a14;
  a14=arg[4]? arg[4][21] : 0;
  if (res[4]!=0) res[4][21]=a14;
  a14=arg[4]? arg[4][22] : 0;
  if (res[4]!=0) res[4][22]=a14;
  a14=arg[4]? arg[4][23] : 0;
  if (res[4]!=0) res[4][23]=a14;
  a14=arg[4]? arg[4][24] : 0;
  if (res[4]!=0) res[4][24]=a14;
  a14=arg[4]? arg[4][25] : 0;
  if (res[4]!=0) res[4][25]=a14;
  a14=arg[4]? arg[4][26] : 0;
  if (res[4]!=0) res[4][26]=a14;
  a14=arg[4]? arg[4][27] : 0;
  if (res[4]!=0) res[4][27]=a14;
  a14=arg[4]? arg[4][28] : 0;
  if (res[4]!=0) res[4][28]=a14;
  a14=arg[4]? arg[4][29] : 0;
  if (res[4]!=0) res[4][29]=a14;
  a14=arg[4]? arg[4][30] : 0;
  if (res[4]!=0) res[4][30]=a14;
  a14=arg[4]? arg[4][31] : 0;
  if (res[4]!=0) res[4][31]=a14;
  a14=arg[4]? arg[4][32] : 0;
  if (res[4]!=0) res[4][32]=a14;
  a14=arg[4]? arg[4][33] : 0;
  if (res[4]!=0) res[4][33]=a14;
  a14=arg[5]? arg[5][0] : 0;
...
static int casadi_f4(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a91=(a91+a72);
  a91=(a91-a49);
  if (res[1]!=0) res[1][5]=a91;
  a91=(a9*a64);
  a92=(a92+a91);
  a91=arg[0]? arg[0][16] : 0;
  a92=(a92-a91);
  if (res[1]!=0) res[1][6]=a92;
  a92=(a9*a27);
  a93=(a93+a92);
  ...
  a84=(a67*a84);
  a82=(a82+a84);
  if (res[2]!=0) res[2][6]=a82;
  a82=arg[3]? arg[3][19] : 0;
  a84=(a9*a82);
  a86=(a86*a93);
  a84=(a84+a86);
  a86=(a85*a93);
  ...
  a49=(a49*a47);
  a90=(a90-a49);
  if (res[2]!=0) res[2][15]=a90;
  a90=(a9*a72);
  a90=(a69+a90);
  a90=(a90-a92);
  if (res[2]!=0) res[2][16]=a90;
  a90=(a9*a67);
  a90=(a74+a90);
  a90=(a90-a91);
  if (res[2]!=0) res[2][17]=a90;
  a90=arg[3]? arg[3][12] : 0;
  a72=(a90-a72);
  a91=cos(a1);
  a92=(a26*a93);
  a49=(a21*a93);
  ...
  a7=(a7*a1);
  a67=(a67-a7);
  if (res[2]!=0) res[2][19]=a67;
  a67=(a9*a90);
  a67=(a76+a67);
  a67=(a67-a69);
  if (res[2]!=0) res[2][20]=a67;
  a67=(a9*a72);
  a67=(a78+a67);
  a67=(a67-a74);
  if (res[2]!=0) res[2][21]=a67;
  a67=arg[3]? arg[3][16] : 0;
  a90=(a67-a90);
  a74=cos(a22);
  a69=(a35*a93);
  a7=(a36*a93);
  ...
  a22=(a22*a74);
  a90=(a90-a22);
  if (res[2]!=0) res[2][22]=a90;
  a90=arg[3]? arg[3][17] : 0;
  a72=(a90-a72);
  a22=cos(a30);
  a74=(a28*a51);
  a96=(a16*a7);
  ...
  a72=(a82+a72);
  a72=(a72-a78);
  if (res[2]!=0) res[2][25]=a72;
  a72=arg[3]? arg[3][20] : 0;
  a67=(a72-a67);
  a78=cos(a37);
  a76=(a45*a93);
  a30=(a46*a93);
  ...
  a39=(a39*a37);
  a90=(a90-a39);
  if (res[2]!=0) res[2][27]=a90;
  a90=(a9*a72);
  a90=(a84+a90);
  a90=(a90-a80);
  if (res[2]!=0) res[2][28]=a90;
  a9=(a9*a67);
  a9=(a86+a9);
  a9=(a9-a82);
  ...
  a86=(-a86);
  if (res[2]!=0) res[2][33]=a86;
  if (res[3]!=0) res[3][0]=a73;
  if (res[3]!=0) res[3][1]=a88;
  ...
  a71=(a71+a70);
  a71=(-a71);
  if (res[3]!=0) res[3][15]=a71;
  a38=(a38*a35);
  a29=(a29*a26);
  a38=(a38+a29);
  a3=(a3*a60);
  a38=(a38+a3);
  if (res[3]!=0) res[3][16]=a38;
  a46=(a46*a44);
  a36=(a36*a34);
  a46=(a46+a36);
  a21=(a21*a17);
  a46=(a46+a21);
  if (res[3]!=0) res[3][17]=a46;
  a48=(a48*a94);
  if (res[3]!=0) res[3][18]=a48;
  a55=(a55*a56);
  if (res[3]!=0) res[3][19]=a55;
  a59=(a59*a45);
  if (res[3]!=0) res[3][20]=a59;
  a13=(a13*a68);
  if (res[3]!=0) res[3][21]=a13;
  a13=(a87*a93);
  a87=(a87*a13);
  a13=(a83*a93);
  a83=(a83*a13);
...
static int casadi_f6(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  if (res[1]!=0) res[1][12]=a90;
  if (res[1]!=0) res[1][13]=a90;
  a73=cos(a47);
  a57=(a57*a55);
  a60=(a60+a57);
  a57=(a15*a60);
  ...
  a90=(a90-a23);
  if (res[2]!=0) res[2][2]=a90;
  a90=arg[1]? arg[1][3] : 0;
  a58=arg[0]? arg[0][13] : 0;
  a90=(a90-a58);
  if (res[2]!=0) res[2][3]=a90;
  a90=1.0000000000000000e-03;
  a15=(a90*a23);
  a73=(a73+a15);
  a73=(a73-a47);
  ...
  a83=(a90*a83);
  a79=(a79+a83);
  a83=arg[0]? arg[0][28] : 0;
  a79=(a79-a83);
  if (res[2]!=0) res[2][18]=a79;
  a85=(a90*a85);
  a81=(a81+a85);
  ...
  if (res[3]!=0) res[3][0]=a90;
  if (res[3]!=0) res[3][1]=a90;
  if (res[3]!=0) res[3][2]=a90;
  if (res[3]!=0) res[3][3]=a90;
  if (res[3]!=0) res[3][4]=a90;
  if (res[3]!=0) res[3][5]=a90;
  if (res[3]!=0) res[3][6]=a90;
  if (res[3]!=0) res[3][7]=a90;
  if (res[3]!=0) res[3][8]=a90;
  if (res[3]!=0) res[3][9]=a90;
  a85=-1.;
  if (res[3]!=0) res[3][10]=a85;
  a89=1.;
  if (res[3]!=0) res[3][11]=a89;
  if (res[3]!=0) res[3][12]=a85;
  if (res[3]!=0) res[3][13]=a89;
  if (res[3]!=0) res[3][14]=a85;
  if (res[3]!=0) res[3][15]=a90;
  if (res[3]!=0) res[3][16]=a89;
  if (res[3]!=0) res[3][17]=a85;
  if (res[3]!=0) res[3][18]=a90;
  if (res[3]!=0) res[3][19]=a89;
  if (res[3]!=0) res[3][20]=a85;
  if (res[3]!=0) res[3][21]=a89;
  if (res[3]!=0) res[3][22]=a85;
  if (res[3]!=0) res[3][23]=a89;
  if (res[3]!=0) res[3][24]=a85;
  if (res[3]!=0) res[3][25]=a90;
  if (res[3]!=0) res[3][26]=a89;
  if (res[3]!=0) res[3][27]=a85;
  if (res[3]!=0) res[3][28]=a90;
  if (res[3]!=0) res[3][29]=a89;
  if (res[3]!=0) res[3][30]=a85;
  if (res[3]!=0) res[3][31]=a89;
  if (res[3]!=0) res[3][32]=a85;
  if (res[3]!=0) res[3][33]=a89;
  if (res[3]!=0) res[3][34]=a85;
  if (res[3]!=0) res[3][35]=a90;
  if (res[3]!=0) res[3][36]=a89;
  if (res[3]!=0) res[3][37]=a85;
  if (res[3]!=0) res[3][38]=a90;
  if (res[3]!=0) res[3][39]=a89;
  if (res[3]!=0) res[3][40]=a85;
  if (res[3]!=0) res[3][41]=a89;
  if (res[3]!=0) res[3][42]=a85;
  if (res[3]!=0) res[3][43]=a89;
  if (res[3]!=0) res[3][44]=a85;
  if (res[3]!=0) res[3][45]=a90;
  if (res[3]!=0) res[3][46]=a89;
  if (res[3]!=0) res[3][47]=a85;
  if (res[3]!=0) res[3][48]=a90;
  if (res[3]!=0) res[3][49]=a89;
  if (res[3]!=0) res[3][50]=a85;
  if (res[3]!=0) res[3][51]=a89;
  if (res[3]!=0) res[3][52]=a85;
  if (res[3]!=0) res[3][53]=a89;
  if (res[3]!=0) res[3][54]=a85;
  if (res[3]!=0) res[3][55]=a90;
  if (res[3]!=0) res[3][56]=a89;
  if (res[3]!=0) res[3][57]=a85;
  if (res[3]!=0) res[3][58]=a90;
  if (res[3]!=0) res[3][59]=a89;
  if (res[3]!=0) res[3][60]=a85;
  if (res[3]!=0) res[3][61]=a85;
  if (res[3]!=0) res[3][62]=a85;
  if (res[3]!=0) res[3][63]=a85;
  return 0;
}
...
static int casadi_f9(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a15=(a18*a3);
  a3=(a3*a15);
  a15=3.3300000000000002e-01;
  a8=(a0*a1);
  a11=(a4*a2);
  a8=(a8+a11);
  a8=(a15-a8);
  a11=(a2*a6);
  a19=4.4408920985006262e-16;
  a20=(a19*a6);
  a20=(a14*a20);
  a11=(a11+a20);
  a20=(a1*a7);
