...
namespace franka_example_controllers
{
    ...
    ConventionalWorkspaceController::command_interface_configuration() const
    {
    ...
    controller_interface::InterfaceConfiguration
    ConventionalWorkspaceController::state_interface_configuration() const
    {
    ...
    controller_interface::return_type ConventionalWorkspaceController::update(
    ...
    CallbackReturn ConventionalWorkspaceController::on_init()
    {
    ...
    CallbackReturn ConventionalWorkspaceController::on_deactivate(const rclcpp_lifecycle::State &)
    {
    ...
    CallbackReturn ConventionalWorkspaceController::on_cleanup(const rclcpp_lifecycle::State &)
    {
        close_shared_memories();
    ...
    CallbackReturn ConventionalWorkspaceController::on_shutdown(const rclcpp_lifecycle::State &)
    {
        close_shared_memories();
    ...
    void ConventionalWorkspaceController::open_shared_memories()
    {
    ...
    void ConventionalWorkspaceController::close_shared_memories()
    {
        shm.close_shared_memories();
        shm.close_semaphores();
    }

    // void ConventionalWorkspaceController::topic_callback(const mpc_interfaces::msg::ControlArray & msg)
    // {
    ...
    void ConventionalWorkspaceController::start_mpc(const std::shared_ptr<mpc_interfaces::srv::SimpleCommand::Request>,
                                                    ...
                                                    std::shared_ptr<mpc_interfaces::srv::SimpleCommand::Response> response)
    {
        ...
        controller_started = false;
        shm.post_semaphore("shm_changed_semaphore");
        RCLCPP_INFO(get_node()->get_logger(), "Workspace Controller reset");
    }

    void ConventionalWorkspaceController::stop_mpc(const std::shared_ptr<mpc_interfaces::srv::SimpleCommand::Request>,
                                                   std::shared_ptr<mpc_interfaces::srv::SimpleCommand::Response> response)
    {
        shm_flags flags = {
            0, // start
        ...
        controller_started = false;
        RCLCPP_INFO(get_node()->get_logger(), "Workspace Controller stopped");
    }
