...
namespace franka_example_controllers
{
        ...
        /*
        This class implements a Model Predictive Controller (MPC) using the Crocoddyl library via python.
        ...
        This class uses shared memory to communicate with the a separate python process that runs the Crocoddyl MPC.
        It reads the state data from ROS2 state interfaces and writes it into the shared memory.
        It sends then a semaphore to the shared memory controller which runs in background. After the
