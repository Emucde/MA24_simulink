...
MPC='MPC3';
param_weight.(MPC).Q_y      = 1e5*diag([1 1]);  % d_kpn
param_weight.(MPC).Q_y_p    = 1e-3*diag([1 1]); % d_kpn
param_weight.(MPC).Q_y_pp   = 1e-3*diag([1 1]); % d_kpn
param_weight.(MPC).Q_y0_pp  = 1e-3*diag([1 1]);  % D_0
param_weight.(MPC).Q_y1     = 1e3*diag([1 1]);  % D_1
param_weight.(MPC).Q_y1_p   = 1e-3*diag([1 1]);  % D_1
param_weight.(MPC).Q_y1_pp  = 1e-3*diag([1 1]);  % D_1
param_weight.(MPC).Q_yN     = 1e5*diag([1 1]);  % D_N
param_weight.(MPC).Q_yN_p   = 0*1e-3*diag([1 1]);  % D_N

param_weight.(MPC).Q_q_p    = 0* 1e-5*diag([1 1e1]);  % c_kpn
param_weight.(MPC).Q_q_pp   = 0* 1e-5*diag([1 1e1]);  % c_kpn
param_weight.(MPC).Q_q0_pp  = 0*   diag([1 1e1]);  % C_0
param_weight.(MPC).Q_qN_p   = 0* 1e-5*diag([1 1e1]);  % C_N
