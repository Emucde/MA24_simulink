...
param_robot.holder.d__joint = [0 0 0];
...
param_robot.link1.d__joint = [param_robot.l__s1 param_robot.l__I 0];
...
param_robot.link2.d__joint = [param_robot.l__1+param_robot.l__s2 param_robot.l__I 0];
